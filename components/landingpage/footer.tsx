...
//   return (
//     <motion.footer
//       className="bg-[#0c0c0c] border-t border-neutral-800"
//       initial="hidden"
//       whileInView="visible"
//       viewport={{ once: true }}
...
//             <h3 className="text-xl font-bold text-white">Syntax</h3>
//             <p className="text-gray-400 text-sm">
//               Optimize your workflow with cutting-edge solutions designed for modern teams.
//             </p>
...
//         >
//           <p className="text-gray-400 text-sm">© 2024 YourCompany. All rights reserved.</p>
    ...
    <footer className="relative bg-white text-gray-900 overflow-hidden">
      ...
      <div className=" inset-0 flex items-center justify-center ">
        <motion.div
          ...
          className="text-[20rem] mt-24 font-bold text-zinc-900"
