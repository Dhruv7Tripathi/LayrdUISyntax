...
export default function CTA() {
  return (
    <div className="bg-black flex flex-col justify-center items-center min-h-screen p-4 md:p-6 rounded-lg shadow-lg">
      <div className='text-center bg-neutral-950 justify-center w-full max-w-8xl rounded-xl p-6 sm:p-8 md:p-12 border border-dashed border-neutral-800 flex flex-col items-center mx-auto'>
        ...
        <p className="mt-4 md:mt-6 mb-6 sm:mb-8 max-w-xl text-center text-white text-sm sm:text-base md:text-lg leading-relaxed px-2">
        ...
        <Link
          href={"/createTodo"}
          className="group w-full sm:w-48 md:w-40 flex items-center justify-center gap-2 rounded-xl border border-neutral-600 bg-neutral-950 px-5 py-3 sm:py-4 text-sm sm:text-base md:text-[1rem] font-semibold text-white shadow-[inset_0px_0px_7px_1px_#535353] transition-all duration-300 hover:bg-neutral-800/50 hover:shadow-[inset_0px_0px_10px_2px_#636363] active:scale-95"
        >
